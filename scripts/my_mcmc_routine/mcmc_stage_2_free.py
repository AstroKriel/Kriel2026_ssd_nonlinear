...
class Stage2MCMCRoutine_free(base_mcmc.BaseMCMCRoutine):
  ...
  def _model(self, param_vectors):
    ...
    alpha              = (sat_energy - start_nl_energy) / (start_sat_time - start_nl_time)**beta # (N,)
    ...
    energy_2d[mask_nl_phase]  = (start_nl_energy_2d + alpha_2d * (x_values_2d - start_nl_time_2d)**beta_2d)[mask_nl_phase] # (N, T)
