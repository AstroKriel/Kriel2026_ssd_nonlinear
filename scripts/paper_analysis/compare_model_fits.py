...
def load_max_ll(sim_directory: Path, model_name: str) -> float | None:
  mcmc_results_path = io_manager.combine_file_path_parts([
    sim_directory, model_name, "bin_per_t0", f"stage2_{model_name}_fitted_log_likelihoods.npy"
  ])
...
def main():
  base_dir = Path("/Users/necoturb/Documents/Codes/asgard/mimir/kriel_2025_ssd_nl/datasets_v2/").resolve()
  ...
  fieldnames = [
    "sim_path","Mach","Re","N",
    "maxLL_linear","maxLL_quadratic",
    "AIC_linear","AIC_quadratic","wAIC_linear","wAIC_quadratic","best_AIC",
    "AICc_linear","AICc_quadratic","wAICc_linear","wAICc_quadratic","best_AICc",
    "BIC_linear","BIC_quadratic","best_BIC",
    "expected_by_Mach","match_AIC","match_AICc","match_BIC",
  ]
  out_csv = base_dir / "model_comparison_summary.csv"
