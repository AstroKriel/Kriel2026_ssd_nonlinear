...
class Stage2MCMCRoutine_linear(base_mcmc.BaseMCMCRoutine):
  ...
  def _model(self, param_vectors):
    ...
    nl_gamma           = (sat_energy - nl_start_energy) / (sat_start_time - nl_start_time) # (N,)
    ...
    energy_2d[mask_nl_phase]  = (nl_start_energy_2d + nl_gamma_2d * (x_values_2d - nl_start_time_2d))[mask_nl_phase] # (N, T)
